...
You can edit a `.mseignore` in your code directory. This file is read by the cli when deploying your app and allows you to avoid to send some files remotely. 
